...
use crate::{bytebuffer::ByteBuffer, err_codec_message, records::MutableBatches, RawTaggedField};
...
pub trait Readable {
    ...
    fn read_records(&mut self, len: usize) -> MutableBatches {
        MutableBatches::new(self.read_bytes(len))
    }
